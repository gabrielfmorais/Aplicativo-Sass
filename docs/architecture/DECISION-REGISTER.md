...
| Campo | Valor |
|---|---|
| Status | v0.10 — 2026-08-27 — SPEC-000/001/002 implementadas/merged; SPEC-003 folded (D-66); **SPEC-004 Draft — modelo técnico CLOSED + regras V1 CANDIDATE (D-67)**; implementação autorizada com `candidate`, PUBLIC RELEASE exige `validated` (D-26/D-67); LEVEL 2 ativo |
