...
| Campo | Valor |
|---|---|
| Status | v0.14 — 2026-08-27 — SPEC-000/001/002/004/**005** implementadas/merged; SPEC-003 folded (D-66). Regras capilares V1 continuam `candidate` (D-67): **PUBLIC RELEASE bloqueado** até o domain sign-off (`candidate → validated`, D-26/OQ-REL). LEVEL 2 ativo |
