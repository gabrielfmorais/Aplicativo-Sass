...
| [SPEC-020](SPEC-020-hair-events.md) | "Meu cabelo mudou": o app fica sabendo | Hair Profile | MASTER PRODUCT BACKLOG — F23 | **IMPLEMENTADA — validação real pendente** (v0.2, 2026-09-01) — o Free **registra e oferece reavaliar**; não interpreta, não aconselha e não diagnostica, que é o que mantém a capability fora do gate D-26. Tabela + 2 RPCs `SECURITY DEFINER`, 17 asserções pgTAP. **Não é DONE:** a migration ainda não foi aplicada no DEV |
...
| [SPEC-022](SPEC-022-schedule-pause.md) | Pausa: parar sem perder nada, e voltar sem culpa | Schedule / Planning | MASTER PRODUCT BACKLOG — F22 | **Draft** (v0.1, 2026-09-01) — **OQ2 é BLOCKING e é decisão humana:** o que acontece com os cuidados na volta move o cronograma dela. O Blueprint fecha as bordas, não o meio |
| [SPEC-023](SPEC-023-my-shelf.md) | Minha Prateleira: os produtos que ela já tem | Hair Profile | MASTER PRODUCT BACKLOG — F26, **antes** do F25 | **Draft** (v0.1, 2026-09-01) — o Free registra o que ela possui, do jeito que ela chama. Não é loja, não é catálogo, não interpreta. Tabela sem RPC. Nenhuma OQ BLOCKING |
