...
| [SPEC-010](SPEC-010-subscription-entitlements.md) | Subscription & Entitlements | Subscription | 9 | **APPROVED — Parte 1** (v0.2, D-78, 2026-08-29): infra provider-agnóstica (PR-A core, PR-B banco, PR-C Edge) autorizada. **Parte 2** (paywall/SDK + 1ª capacidade premium) bloqueada por OQ1/OQ2/OQ3 (D-79). Requer label `security` |
