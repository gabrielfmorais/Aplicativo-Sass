...
| [SPEC-010](SPEC-010-subscription-entitlements.md) | Subscription & Entitlements | Subscription | 9 | **Draft** (2026-08-29) — infra Billing→Subscription→Entitlement + paywall provider-agnósticos; OQ BLOCKING: provider+custo, preço, 1ª capacidade premium (human gates). Requer label `security` |
