...
| [SPEC-004](SPEC-004-schedule-engine-generate-plan.md) | Schedule Engine v1 + generate-plan (inclui Assessment — D-66) | Schedule | 4 | **Draft v0.3 — modelo técnico CLOSED FOR REVIEW; único blocker = DOMAIN RULES (HUMAN GATE, D-26)** |
