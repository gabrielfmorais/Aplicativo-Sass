...
| [SPEC-003](SPEC-003-diagnostic-engine-v1.md) | Diagnostic Engine v1 | Diagnostic | 3 | **Draft v0.2 — decisão de arquitetura pendente (separar vs. fold em SPEC-004, OQ0); regras = HUMAN GATE (D-26)** |
