...
| [SPEC-019](SPEC-019-cycle-view.md) | Visão de ciclo: as quatro semanas dela, depois de começarem | Care Tracking (calendar projection) | MASTER PRODUCT BACKLOG — F20 | **Draft** (v0.1, 2026-09-01) — fecha o `IN PROGRESS` do F20. Sem SQL, sem contrato, sem dependência. Nenhuma OQ BLOCKING |
