...
| [SPEC-023](SPEC-023-my-shelf.md) | Minha Prateleira: os produtos que ela já tem | Hair Profile | MASTER PRODUCT BACKLOG — F26, **antes** do F25 | **IMPLEMENTADA — validação real pendente** (v0.2, 2026-09-01) — o Free registra o que ela possui, do jeito que ela chama. Não é loja, não é catálogo, não interpreta. Tabela sem RPC, 15 asserções pgTAP |
| [SPEC-024](SPEC-024-wash-day.md) | Wash Day: o que ela realmente fez | Care Tracking | MASTER PRODUCT BACKLOG — F25 | **Draft** (v0.1, 2026-09-01) — o hub do produto, e **estrutural**: vocabulário fechado em tudo, hub sem colunas de conteúdo. **OQ3 é a única com risco de domínio** — uma lista de técnicas que escorregue de "o que ela faz" para "o que aquilo provoca" joga a capability no gate D-26 |
