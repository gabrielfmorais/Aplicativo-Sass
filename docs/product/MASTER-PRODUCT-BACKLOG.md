...
| F49 | **Rotina noturna / proteção noturna** | **COMMITTED** — `DEFERRED BY PRIORITY`, não por dependência técnica | Registrada pelo dono em 2026-09-07, **explicitamente fora da prioridade imediata**. O produto conhece o cuidado do dia, o registro do que ela fez, a finalização e a rotina de óleo — **o que acontece entre deitar e acordar não existe para ele**, e para muita gente é a parte que mais se repete. Fatos configuráveis: **touca de cetim · fronha de cetim · trança · proteção/coque · cabelo solto · outra · nenhuma rotina específica**, com dias, horários, lembretes, registro e histórico. ⚠️ **A forma já existe:** é o padrão do `F39` (rotina paralela ao cronograma, cadência dela, lembrete no horário dela, histórico append-only, dia civil por RPC), então o custo é de superfície, não de arquitetura. ⛔ **Nenhuma opção é recomendada, ordenada por mérito ou marcada como a certa** — *"você deve dormir de trança"* e *"você deve usar touca"* são **alegação capilar** e dependem de **D-26/D-70** (instrução literal do dono). ⛔ *"Nenhuma rotina específica"* é resposta legítima, não falha a corrigir. ⛔ **Nada de pontos, elogio ou sequência por proteger mais noites** (D-103). ⛔ **Não entra no cronograma** (a NG1 do `F39`). O que ela **registra** é utilizável antes de qualquer sign-off; o que ela **recomenda** não existe. Blueprint §28. |
...
| P14 | **Insights de cabelo** | **DEFERRED BY DEPENDENCY** | Saída da P2. ⚠️ **A primeira fatia útil já entrou pela SPEC-047 §16**: *"Frizz — você notou em 4 dos 6 cuidados que você avaliou"*, sem atribuição nenhuma. ⛔ **O que falta é o que o produto promete e o que engenharia não pode dar sozinha**: ligar a marca ao que ela usou (*"com a Máscara X você notou maciez em 4 de 5"*) faz o resultado ter **nome de propriedade capilar**, e a co-ocorrência passa a ler como causa — **gate D-26/D-70**, a mesma fronteira da `P18` (SPEC-047 OQ5). |
