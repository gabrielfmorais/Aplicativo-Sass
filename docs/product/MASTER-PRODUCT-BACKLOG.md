...
| F25 | **Wash Day básico** | **IN PROGRESS** — SPEC-024 (Draft) | Estrutural (§6). Free **registra**. Depois do F26 (SPEC-023): o Wash Day é o hub e consome os produtos. **Vocabulário fechado em tudo** — texto livre aqui destruiria P5, P6, P7 e P8. |
