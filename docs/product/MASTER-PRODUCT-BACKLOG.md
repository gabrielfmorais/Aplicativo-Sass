...
| F34 | **Perfil dela: nome, foto e avatar** | **COMMITTED** | O acesso já existe — o avatar no cabeçalho de toda aba (SPEC-026 fatia 7), hoje com a inicial do nome. Falta o resto do que a área de perfil deve reunir: **editar nome** · **adicionar/trocar foto** · **escolher um avatar ilustrado como alternativa** · preferências · lembretes · Premium · privacidade · conta. Lembretes, Premium e conta **já estão lá**; nome, foto e avatar não. **Foto é mídia**, então divide a dependência do `F28`: storage, custo, privacidade e base legal — e é por isso que o avatar ilustrado é a via barata de personalização enquanto a foto espera. |
