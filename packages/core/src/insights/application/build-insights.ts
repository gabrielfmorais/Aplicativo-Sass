...
export const buildInsights = (
  ...
  return {
    ...
    observations,
    /**
     * SPEC-050 (`P8`) — **tudo o que andou junto**, sobre **todos** os cuidados avaliados e não só
     * os bem avaliados: o denominador do padrão é o cuidado em que os dois apareceram, e é isso que
     * faz a segunda contagem significar alguma coisa (BR2).
     *
     * ⚠️ **SPEC-050 OQ1 (2026-09-06) — o par de produtos mora AQUI, e só aqui.** Ele era a
     * observação `combo` da SPEC-049, contada dentro dos cuidados *bem avaliados* e sem teto; a
     * tela terminava com **duas** seções de "coisas que andaram juntas", com frases e denominadores
     * diferentes e nada explicando por quê. Agora um par é um par: uma regra, uma frase, um
     * denominador e **um** teto de `MAX_PATTERNS` para todos — que é literalmente o pedido de
     * *"poucos padrões realmente informativos"*, já que o `combo` não tinha teto nenhum.
     */
